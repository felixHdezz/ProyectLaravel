	...
	<div class="container">
		...
		<div class="col-sm-6 col-sm-offset-3 login_borber">
				<div class="col-sm-8 col-sm-offset-2">
	                ...
	                <form class="form" action="{{url('/login-admin')}}" method="POST">
	                	{!! csrf_field() !!}
	                        <div class="form-group">
	                            <label class="">Usuario:</label>
	                            <input type="text" class="form-control" placeholder="Ingrese el correo electronico" name="user" required="requiered" width="100">
	                        </div>
	                        <div class="form-group">
